...
import com.quickcleanpro.phonecleaner.common.analytics.SdkAnalyticsSink
...
import com.quickcleanpro.phonecleaner.app.navigation.feature.fileFeatures
...
object AnalyticsTracker {
    ...
    private lateinit var preferences: AnalyticsPreferences

    fun initialize(preferences: AnalyticsPreferences) {
    ...
    fun hasCompletedCleanup(): Boolean = preferences.hasCompletedCleanup()
    ...
    private fun writeOnceUserProperties(firstOpenTime: String) {
        if (preferences.hasReportedOnceUserProperties()) return
        ...
        if (deviceWritten && firstOpenWritten) {
            preferences.markOnceUserPropertiesReported()
        }
    }
    ...
    private fun incrementCleanCompleted() {
        preferences.incrementCompletedCleanup()
    }
