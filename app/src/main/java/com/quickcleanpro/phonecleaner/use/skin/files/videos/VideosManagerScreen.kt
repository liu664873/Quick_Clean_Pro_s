package com.quickcleanpro.phonecleaner.use.skin.files.videos

import com.quickcleanpro.phonecleaner.app.navigation.AppDestination

import com.quickcleanpro.phonecleaner.use.feature.files.presentation.common.FileImageDisplayItem
import com.quickcleanpro.phonecleaner.use.feature.files.presentation.videos.VideosManagerUiState
...
import com.quickcleanpro.phonecleaner.use.skin.files.common.components.FileManagerMediaGridView
...
@Composable
private fun VideosManagerScreenState(navigator: AppNavigator, dependencies: AppRouteDependencies, viewModel: VideosManagerViewModel) {
    ...
    FileManagerScaffold(
        ...
        VideosManagerContent(
            ...
            onOpenDetail = { item ->
                ...
                router.openRoute(AppDestination.VideosDetail.withDetailInitialIndex(index))
            },
