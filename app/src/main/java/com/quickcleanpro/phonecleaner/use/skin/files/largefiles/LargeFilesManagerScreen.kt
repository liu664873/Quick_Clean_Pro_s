package com.quickcleanpro.phonecleaner.use.skin.files.largefiles

import com.quickcleanpro.phonecleaner.app.navigation.AppDestination

import com.quickcleanpro.phonecleaner.use.feature.files.presentation.largefiles.LargeFilesListStyle
import com.quickcleanpro.phonecleaner.use.feature.files.presentation.largefiles.LargeFilesManagerUiState
...
@Composable
private fun LargeFilesManagerScreenState(navigator: AppNavigator, dependencies: AppRouteDependencies, viewModel: LargeFilesManagerViewModel) {
    ...
    FileManagerScaffold(
        ...
        LargeFilesManagerContent(
            ...
            onOpenDetail = { item ->
                ...
                router.openRoute(AppDestination.LargeFilesDetail.withDetailInitialIndex(index))
            },
