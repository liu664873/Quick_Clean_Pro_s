package com.quickcleanpro.phonecleaner.use.skin.files.audios

import com.quickcleanpro.phonecleaner.app.navigation.AppDestination

import com.quickcleanpro.phonecleaner.use.feature.files.presentation.common.FileImageDisplayItem
import com.quickcleanpro.phonecleaner.use.feature.files.presentation.audios.AudiosManagerUiState
...
import com.quickcleanpro.phonecleaner.use.skin.files.common.components.FileManagerAudioListView
...
@Composable
private fun AudiosManagerScreenState(navigator: AppNavigator, dependencies: AppRouteDependencies, viewModel: AudiosManagerViewModel) {
    ...
    FileManagerScaffold(
        ...
        AudiosManagerContent(
            ...
            onOpenDetail = { item ->
                ...
                router.openRoute(AppDestination.AudiosDetail.withDetailInitialIndex(index))
            },
